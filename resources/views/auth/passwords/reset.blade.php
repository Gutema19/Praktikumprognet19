...
<head>
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
  <script src="/js/user/npass.js" type="text/javascript"></script>
...
<body>
  ...
  <div class="register-content">
    <div class="login-pic2" data-aos="fade-in" data-aos-delay="625">
      <img src="/component/Group 11.svg" alt="gambar1">
    </div>
    <div class="login-pic3" data-aos="fade-in" data-aos-delay="635">
      <img src="/component/Line 2.svg" alt="gambar2">
    </div>
    <div class="login-container1">
      <h1 data-aos="fade-up" data-aos-delay="625">Password</h1>
      <div class="proses" data-aos="fade-up" data-aos-delay="635">
        <img src="/component/Group 8.svg" alt="progresspic">
      </div>
      <span data-aos="fade-up" data-aos-delay="645">In this part you must fill the data for your new password. Please fill the data require below.</span>
      <form class="form-login">
        ...
        <div class="mb-3" data-aos="fade-up" data-aos-delay="655">
        ...
        <div class="mb-3 form-check" data-aos="fade-up" data-aos-delay="665">
          <input type="checkbox" class="form-check-input" id="exampleCheck1" onclick="showpass1()">
          <label class="form-check-label" for="exampleCheck1">Show Password</label>
        </div>
        <button type="submit" class="btn btn-secondary log" data-aos="fade-up" data-aos-delay="675">Next</button>
      </form>
      <div class="footer" data-aos="fade-up" data-aos-delay="685">
