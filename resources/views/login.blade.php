...
<body>
    ...
    <div class="login-container1">
        <h1>Login</h1>
        <span>Welcome to Hilton, the center of trendy fashion in the world please enter your email and password below.</span>
        ...
        <button type="submit" class="btn btn-secondary reg">Register</button>
        <div class="footer">
